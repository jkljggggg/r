...
REPO_DIR = "/home/r/.git/" # ** CHANGE THIS to your bot's directory if it's not the current one **
...
async def ping(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    t2 = time.time()
    # Corrected line 283: Removed backslashes from inside the f-string expression
    # and ensured correct MarkdownV2 escaping for literal special characters.
...
async def cleanwelcome(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # Only admins/owner can use this
    if not await is_admin_or_owner(update, context):
        await update.message.reply_text("🚨 𝐀𝐫𝐞 𝐛𝐚𝐛𝐮, 𝐞 𝐤𝐚𝐦𝐚𝐧𝐝 𝐭𝐨𝐡 𝐛𝐚𝐬 𝐀𝐝𝐦𝐢𝐧 𝐚𝐮𝐫 𝐌𝐚𝐥𝐢𝐊 \\(𝐎𝐰𝐧𝐞𝐫\\) 𝐤𝐞 𝐥𝐢𝐲𝐞 𝐛𝐚\\! 🚫 𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐥𝐢𝐲𝐞 𝐧𝐚𝐡𝐢\\! 🤷‍♀️ _\\(Aukaat me raho!\\)_")
        return
